...
export default class LinkedInModal extends React.Component {
    constructor() {
        ...
        this.renderWebview = () => {
            ...
            return (React.createElement(WebView, { source: { uri: this.getAuthorizationUrl() }, style: webviewStyle, onNavigationStateChange: this.onNavigationStateChange, startInLoadingState: true, javaScriptEnabled: true, domStorageEnabled: true, injectedJavaScript: injectedJavaScript, sharedCookiesEnabled: true }));
        };
    }
